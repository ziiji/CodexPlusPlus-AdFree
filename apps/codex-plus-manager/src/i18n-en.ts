...
export const EN_PLAIN: Record<string, string> = {
  ...
  "VLM 仅支持 Chat Completions 协议和聚合模式": "VLM supports only the Chat Completions protocol and aggregate mode",
  ...
  "若开启 VLM analysis，请确认 VLM 配置项完整且服务可用。": "If VLM analysis is enabled, confirm that the VLM configuration is complete and the service is available.",
  "仅在 Chat Completion 和聚合模式生效。": "Effective only for Chat Completion and aggregate mode.",
  "VLM 配置不完整：API Key、Model 和 Base URL 为必填项，否则 VLM 不会生效。": "VLM configuration is incomplete: API Key, Model, and Base URL are required, otherwise VLM will not take effect.",
};
