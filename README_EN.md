...
Version numbers follow upstream releases. For example, upstream `v1.2.45` maps to this fork's `v1.2.45`. One ad-free build is published for each upstream version. The app checks the Release asset `latest.json` to discover and install updates.
